% 11/06/2020
function [x,resnorm,exitflag, outeriter] = LHDM(C,d,options) 
...
%    k     maximum number of indices to be added to the Passive set at 
%          each iteration
...
%          0 and 1 
%    thres_w threshold on the dual variable for the contruction of the
%          candidate set
...
% outeriter: number of iterations for convergence
